...
format:
  lumo-html:
    ...
    bg-image: "_assets/data_viz_heatmap_bg.png"              
execute:
  warning: false
  message: false
  cache: true
...
Taxa <-read_xlsx("./../input/Literature_HeatMap_Data_for_pheatmap.xlsx", sheet = 1)
Taxa <- tibble::column_to_rownames(Taxa, var = names(Taxa)[1])

annotation_table <- read_xlsx("./../input/Literature_HeatMap_Data_for_pheatmap.xlsx", sheet = 2)
...
```{r, message=FALSE}
Taxa<-read_xlsx("./../input/Literature_HeatMap_Data_for_ggplot2.xlsx", sheet = 1) 
Taxa <- tibble::column_to_rownames(Taxa, var = names(Taxa)[1])

annotation_table <- read_xlsx("./../input/Literature_HeatMap_Data_for_ggplot2.xlsx", sheet = 2)
annotation_table <- tibble::column_to_rownames(annotation_table, var = names(annotation_table)[1])
```
